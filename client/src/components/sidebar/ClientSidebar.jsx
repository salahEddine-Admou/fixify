...
const ClientSidebar = () => {
    ...
    const items = [
        getItem(<NavLink className="no-underline" to="/client/list-resevation">
            Reservations
        </NavLink>, '/client/list-resevation', <CalendarOutlined />),

        getItem(<NavLink className="no-underline" to="/client/fav-repairers">
            Favoris
        </NavLink>, '/client/fav-repairers', <HeartFilled />),
